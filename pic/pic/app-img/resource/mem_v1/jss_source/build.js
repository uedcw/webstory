...
//    optimize:'none',
    modules: [
        {name: 'page/member1_1-home'},
        {name: 'page/member1_2-home'},
        {name: 'page/member2_1-home'},
        {name: 'page/member2_2-home'},
        {name: 'page/member2_5-home'},
        {name: 'page/member3_1-home'},
        {name: 'page/member3_2-home'},
        {name: 'page/member2_7-home'},
        {name: 'page/template_list'},
    ],
    paths:{
        'jquery':           'empty:',                   // 不参与合并
        ...
        'searchauto':       'pub_jss/mod/searchauto',           // 搜索框自动完成
        ...
        'member':           'pub_jss/mod/member',             // 会员中心公共事件
