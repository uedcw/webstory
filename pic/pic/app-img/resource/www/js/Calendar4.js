...
L_calendar.prototype={
	...
	CreateHTML:function(){
		...
		stylestr+="body{;font-size:12px;margin:0px;padding:0px;text-align:left}\r\n";
		stylestr+="#L_calendar{border:1px solid blue;width:158px;padding:1px;height:180px;background-color:#fff;z-index:9998;text-align:center}\r\n";
