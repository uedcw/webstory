    ...
    a.fn.slides = function(b) {
        return b = a.extend({}, a.fn.slides.option, b), this.each(function() {
            ...
            b.bigTarget && (d.children().css({
                ...
                y()
            })), b.generateNextPrev && (a("." + b.container, c).after('<a href="#" class="'+ b.switchForm+' ' + b.prev + '">Prev</a>'), a("." + b.prev, c).after('<a href="#" class="'+ b.switchForm+' ' + b.next + '">Next</a>')), a("." + b.next, c).click(function(a) {
