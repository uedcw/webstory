myFocus.pattern.extend({//*********************tbhuabao******************
	'mF_tbhuabao':function(settings,$){
		...
		$dotList.each(function(i){j=i+1;this.innerHTML='<a href="javascript:;">'+j+'</a>'});//小点
		var $prevBtn=$focus.addHtml('<div class="prev btn"><a href="javascript:;">&#8249;</a></div>');
		var $nextBtn=$focus.addHtml('<div class="next btn"><a href="javascript:;">&#8250;</a></div>');
		//CSS
		var w=settings.width,h=settings.height,dotH=32,arrTop=h/2-32,n=$txtList.length;
		$focus[0].style.height='340px';
