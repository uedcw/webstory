...
*/
    ...
    function init(){
        $('input.s_key_input').focus(function(){
            ...
            ///'/'+LENG+'/search.html?search_type=text&search_type=remind&lang=
            $.get('/index.php?app=search&search_type=remind&lang='+LENG,{search_keyword:v},function(rs){
                if(!rs.done)return;
                if(rs.retval.len){
