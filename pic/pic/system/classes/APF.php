<?php
/**
 * $Id: APF.php 26 2010-07-25 14:10:33Z microhuang $
 */
apf_require_class("APF_Interceptor");

final class APF {
    const VERSION = '1.0.20141215';
    //const DEFAULT_BENCHMARK = "APF";
    const HTML_ID_PREFIX = "apf_id_";
    ...
    public function shutdown() {
        ...
        $this->benchmark('*APF',array('b'=>$this->apf_time,'bm'=>0,'i'=>1,'e'=>$this->apf_time+$apf_time,'em'=>0));
