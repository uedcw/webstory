...
class APF_Xhprof {
    ...
    public function __construct() {
        ...
        APF::get_instance()->register_shutdown_function(array($this, "shutdown_xprof"));
    }
    ...
    public function benchmark_end() {
        $controller = APF::get_instance()->get_current_controller();
    ...
    public function view_xprof($id) {
        $aifang_tools_domain = APF::get_instance()->get_config("aifang_tools_domain");
