...
class APF_Resource_JavascriptsAndStylesComponent extends APF_Component {
    ...
    public function get_javascripts($head=false) {
        return APF::get_instance()->get_javascripts($head);
    }

    public function get_styles() {
        return APF::get_instance()->get_styles();
    }

    public function get_boundable_javascripts() {
        return APF::get_instance()->get_boundable_javascripts();
    }

    public function get_boundable_styles() {
        return APF::get_instance()->get_boundable_styles();
    }
    ...
    public function cdn_prefix() {
        if (!$this->cdn_prefix) {
            ...
            $host = APF::get_instance()->get_config("cdn_host", "resource");
            $path = APF::get_instance()->get_config("cdn_path", "resource");
    ...
    public function get_style_uri($resource) {
        return APF_Resource_ResourcesController::build_uri($resource);
    }
 ...
 //       if (APF::get_instance()->get_config('css_use_same_host','resource')) {
    ...
    public function is_boundable_resources_enabled() {
        return APF::get_instance()->get_config('boundable_resources', "resource");
    }

    public function get_boundable_styles_uri() {
        return APF_Resource_ResourcesController::build_boundable_uri($this->get_page_class(), "css");
    }

    public function get_boundable_javascripts_uri() {
        return APF_Resource_ResourcesController::build_boundable_uri($this->get_page_class(), "js");
    }
