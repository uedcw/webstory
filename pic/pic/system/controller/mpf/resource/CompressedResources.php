 ...
 * added by htlv
 */
class MPF_Resource_CompressedResourcesController extends
    MPF_Resource_ResourcesController {
    /**
     * 压缩服务服务器地址配置字段
     * @var string
     */
    ...
    public function handle_request() {
        ...
        $host = @$mpf->get_config(self::CONFIG_N_YUICOMPRESSOR_HOST,
            parent::CONFIG_F_RESOURCE);
        $port = @$mpf->get_config(self::CONFIG_N_YUICOMPRESSOR_PORT,
            parent::CONFIG_F_RESOURCE);
