...
$yahoo = $mc->addURL('http://dev20.molbase.dev/test',
	array(CURLOPT_PROXY => '127.0.0.1:80', CURLOPT_POST => 1, CURLOPT_HTTPAUTH => CURLAUTH_DIGEST, CURLOPT_USERPWD => "myusername:mypassword",
	http_build_query(array('var1'=>'value','var2'=>'value'))));
$google = $mc->addURL('http://dev20.molbase.dev/test');
$c3 = $mc->addURL('http://dev20.molbase.dev/test');
//取响应状态
var_dump($yahoo->code);
var_dump($google->code);
var_dump($c3->code);
//取响应内容
echo $yahoo->data;
echo $google->data;
