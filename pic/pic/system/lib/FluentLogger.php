...
class FluentLogger extends BaseLogger
{
     ...
     * @return FluentLogger
     */
    public function __construct($host = self::DEFAULT_ADDRESS,
...
abstract class BaseLogger
{
     ...
     */
    public function defaultErrorHandler(BaseLogger $logger, $entity, $error)
    {
        error_log(sprintf("%s %s %s: %s", get_class($logger), $error, $entity[0], json_encode($entity[1])));
    }
     ...
     * @param void $error error message
     */
    protected function processError($entity, $error)
    {
     ...
     */
    protected function pack ($entity)
    {
